...
The default CSV examples now omit any leading index column. Both the generation script and the library strip these index columns and normalize headers when building models, preventing `KeyError` issues.
